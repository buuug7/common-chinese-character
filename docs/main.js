    ...
    var d = {
        ...
        methods: {
          handleClick() {
            ...
            const { item: t } = this;
            window.open(
              `https://hanyu.baidu.com/zici/s?wd=${t.text}&query=${t.text}&srcid=28232&from=kg0`
            );
          }
        }
      },
    ...
    var v = {
        ...
        methods: {
          getData(t) {
            n(12)(`./${t}.json`)
              .then(({ data: t }) => {
                console.log("data", t), (this.items = t);
              })
              .catch(t => {
                console.error(t);
              });
